...
def estimate_distance(bbox_width, focal_length=500, known_width=2.0):
    return (known_width * focal_length) / bbox_width if bbox_width > 0 else -1

def run_car_detection_with_distance(video_path, weights = "yolov8n.pt", output_csv_path=None):
    ...
    print(f"Tracked car detection with distance saved to {output_csv_path}")
# import cv2
# import numpy as np
# import math
# import time
